...
export class AuthService {
    ...
    constructor(private http: HttpClient, @Inject('identityBaseUrl') private identityBaseUrl: string) { }

    private tenantHeader(tenantId: string): HttpHeaders {
    ...
    login(tenantId: string, userId: string, password: string): Observable<User> {
        const encodedPassword: string = AuthService.encodePassword(password);
        const loginUrl = '/token?grant_type=password&username=';
        return this.http.post<User>(
            this.identityBaseUrl + loginUrl + userId + '&password=' + encodedPassword, {},
